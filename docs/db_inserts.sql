...
INSERT INTO db_de_castilla.Producto (nombre_Producto, precio_Producto, imagen_Producto, id_Categoria_FK, estado) VALUES 
  ...
  ('Oblea con adicional', 3000, 'productos/oblea-adicional.jpg', 1, 1),
  ('Oblea sencilla', 2000, 'productos/oblea-sencilla.jpg', 1, 1),
  ('Cupcake', 6000, 'productos/cupcake.jpg', 2, 1),
  ('Malteada grande', 15000, 'productos/malteada-grande.jpg', 3, 1),
  ('Malteada mediana', 12000, 'productos/malteada-mediana.jpg', 3, 1),
  ('Cheesecake', 6000, 'productos/cheesecake.jpg', 4, 1),
  ('Tres leches', 6000, 'productos/tres-leches.jpg', 4, 1),
  ('bandeja tres leches', 50000,'imagen8.jpg',4, 1),
  ('Merengon', 10000, 'productos/merengon.jpg', 4, 1),
  ('Torta de zanahoria', 4000, 'productos/torta-zanahoria.jpg', 5, 1),
  ('Capuchino', 2500, 'productos/capuchino.jpg', 7, 1),
  ('Tinto', 1500, 'productos/tinto.jpg', 7, 1),
  ('Mocaccino', 2500, 'productos/mocaccino.jpg', 7, 1),
  ('Helado sencillo', 2500, 'productos/image-11.jpg', 8, 1),
  ('Helado doble', 4500, 'productos/helado-doble.png', 8, 1),
  ('Helado triple', 6500, 'productos/helado-tripe.png', 8, 1),
  ('Torta desemilla de amapola y naranja',4000, 'productos/amapola-naranja.jpg',5, 1),
  ('Torta de agras', 5000,'productos/torta-agraz.jpg',5, 1),
  ('Torta de chocolate', 4000,'productos/torta-chocolate.jpg',5, 1),
  ('Torta de vainilla', 4000,'productos/torta-vainilla.jpg',5, 1),
  ('Waffle sencillo', 11000, 'productos/waffle.jpg', 10, 1),
  ('Waffle especial con fruta', 14000,'productos/waffle-frutas.jpg',10 , 1),
  ('Malteada pequeña', 10000,'productos/malteada-peque%C3%B1a.jpg',3 , 1),
  ('Copa de helado con fruta', 10000, 'productos/helado-frutas.jpg', 8, 1),
  ('Brownie con helado', 7000, 'productos/brownie-helado.jpg',8, 1),
  ('Matrimonio', 6000,'imagen18.jpg', 4, 1),
  ('Dulce de papayuela', 6000,'imagen18.jpg', 6, 1),
  ('Leche asada', 7000, 'productos/leche-asada.jpg', 4, 1),
  ('Dulce tropical', 6000,'imagen18.jpg', 6, 1),
  ('Flan de caramelo',6000, 'productos/flan-caramelo.jpg', 4, 1),
  ('Arroz con leche', 3000,'productos/arroz-leche.jpg', 4, 1),
  ('Brebas con arequipe', 6000 ,'productos/brevas-arequipe.png', 6, 1);
...
INSERT INTO db_de_castilla.historico(fecha_movimiento, cantidad_Historico, tipo_Historico, id_Insumo_FK, id_tipo_Movimiento_FK, estado) VALUES 
  (NOW(), 100,'INSUMO', 1, 1, 1),
  (NOW(), 100,'INSUMO', 2, 1, 1),
  (NOW(), 100,'INSUMO', 3, 1, 1),
  (NOW(), 100,'INSUMO', 4, 1, 1),
  (NOW(), 100,'INSUMO', 5, 1, 1),
  (NOW(), 100,'INSUMO', 6, 1, 1),
  (NOW(), 100,'INSUMO', 7, 1, 1),
  (NOW(), 100,'INSUMO', 8, 1, 1),
  (NOW(), 100,'INSUMO', 9, 1, 1),
  (NOW(), 100,'INSUMO', 10, 1, 1),
  (NOW(), 100,'INSUMO', 11, 1, 1),
  (NOW(), 100,'INSUMO', 12, 1, 1),
  (NOW(), 100,'INSUMO', 13, 1, 1),
  (NOW(), 100,'INSUMO', 14, 1, 1),
  (NOW(), 100,'INSUMO', 15, 1, 1),
  (NOW(), 100,'INSUMO', 16, 1, 1),
  (NOW(), 100,'INSUMO', 17, 1, 1),
  (NOW(), 100,'INSUMO', 18, 1, 1),
  (NOW(), 100,'INSUMO', 19, 1, 1),
  (NOW(), 100,'INSUMO', 20,1, 1);
...
INSERT INTO db_de_castilla.historico(fecha_movimiento, cantidad_Historico, tipo_Historico, id_Producto_FK, id_tipo_Movimiento_FK, estado) VALUES 
  ( NOW(), 100, 'PRODUCTO', 1, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 2, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 3, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 4, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 5, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 6, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 7, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 8, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 9, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 10, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 11, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 12, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 13, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 14, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 15, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 16, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 17, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 18, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 19, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 20, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 21, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 22, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 23, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 24, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 25, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 26, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 27, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 28, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 29, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 30, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 31, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 32, 1, 1),
  ( NOW(), 100, 'PRODUCTO', 33, 1, 1);
